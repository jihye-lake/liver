...
public class PanelTest_2_1 extends Frame {  // 버튼 두 개를 만들어서 중앙에 배치하기
															   // setLayout|(null); 을 해주고
															   // panel 따로따로 Size 와 Location 해주기
															  
	
	public PanelTest_2_1(String title) {
		super(title);
		setLayout(null);
		setLocation(900, 200);
		setSize(400, 400);
...
//		panel2.setBackground(new Color(255,205,18));
		...
		panel3.add(new Button("버튼2"));
		panel3.setSize(300, 100);
		panel3.setLocation(50, 200);  //프레임을 패널 위에 올려서 배치시킨다.
