...
public class Button_3_2 extends Frame {
	
	Label[]		lbl		= new Label[500]; //배열 만듦
	Button[]	btn	= new Button[500]; //배열 버튼
	
	public Button_3_2(String str) {
		super(str);
...
//			setBackground(new Color((int)((Math.random()*(255-200))+200),(int)((Math.random()*(255-200))+200),(int)(Math.random()*20)));
			lbl[i].setBackground(new Color((int)((Math.random()*(255-200))+200),(int)(Math.random()*120),(int)(Math.random()*140)));
			btn[i].setBackground(new Color((int)((Math.random()*(255-200))+200),(int)(Math.random()*100),(int)(Math.random()*130)));
